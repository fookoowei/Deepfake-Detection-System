...
def main():
	...
	output_path = os.path.join('./pretrained_model', name)
...
if __name__ == '__main__':
	...
	parse.add_argument('--name', '-n', type=str, default='deepfake_c0_xception')
	parse.add_argument('--train_list', '-tl' , type=str, default = './data_list/Deepfakes_c0_train.txt')
	parse.add_argument('--val_list', '-vl' , type=str, default = './data_list/Deepfakes_c0_val.txt')
